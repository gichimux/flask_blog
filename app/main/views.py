...
def users(nickname):
    ...
    if user == None:
        flash(nickname + 'User does not exist：')
...
def edit_profile():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(current_user)
        flash('Data Successfully Resubmitted')
...
def post(id):
    ...
    if form.validate_on_submit():
        ...
        flash('Comment successfully Published')
